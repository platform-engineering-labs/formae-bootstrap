...
See [Updating the agent](https://docs.formae.ai/documentation/guides/install-agent#update).
...
**[Install and run the agent on AWS](https://docs.formae.ai/documentation/guides/install-agent)**.
